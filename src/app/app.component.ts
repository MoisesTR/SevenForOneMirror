...
export class AppComponent {
	...
	constructor(seo: Meta, title: Title) {
		...
		seo.addTags([
			...
			{ name: "twitter:image", content: "https://raw.githubusercontent.com/MoisesTR/images/master/7x1/ogimage.png" }
		]);
		...
		seo.addTags([
			...
			{ property: "og:image", content: "https://raw.githubusercontent.com/MoisesTR/images/master/7x1/ogimage.png" },
